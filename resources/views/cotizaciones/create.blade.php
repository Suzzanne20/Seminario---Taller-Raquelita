...
<div class="container">
  <div class="md-card">
    <h2 class="md-title">Nueva Cotización</h2>
    ...
    <form action="{{ route('cotizaciones.store') }}" method="POST" novalidate>
      ...
      <div class="mb-3">
        ...
        <input type="text" name="descripcion"
               ...
               value="{{ old('descripcion') }}" required placeholder="Breve detalle de la cotización">
      </div>
        ...
        <div class="col-md-6">
          ...
          <select name="type_service_id"
            ...
            @foreach($servicios as $servicio)
              <option value="{{ $servicio->id }}" @selected(old('type_service_id')==$servicio->id)>
                {{ $servicio->descripcion }}
              </option>
            @endforeach
          </select>
          <div class="help">Tipo/paquete principal que se cotiza</div>
        </div>
        <div class="col-md-6">
          ...
          <input type="number" step="0.01" min="0"
                 ...
                 value="{{ old('costo_mo', 0) }}" placeholder="0.00">
          <div class="help">Puedes dejar 0 si no aplica</div>
        </div>
      </div>
      ...
      <div class="d-flex gap-2 mt-4">
        <button type="submit" class="btn btn-theme px-4">Guardar Cotización</button>
