...
<div class="container">
  <div class="md-card">
    <h2 class="md-title"><i class="bi bi-pencil-square"></i></h2>
    ...
    <form action="{{ route('clientes.update', $cliente->id) }}" method="POST" novalidate>
      ...
      <div class="mb-3">
        ...
        <input id="nombre" name="nombre" type="text"
               ...
               value="{{ old('nombre', $cliente->nombre) }}" required maxlength="45">
      </div>
      ...
      <div class="row g-3">
        <div class="col-md-6">
          ...
          <input id="nit" name="nit" type="text"
                 ...
                 value="{{ old('nit', $cliente->nit) }}" maxlength="20"
        ...
        <div class="col-md-6">
          ...
          <input id="telefono" name="telefono" type="text"
                 ...
                 maxlength="20" placeholder="Ej. 5555-5555">
        </div>
      </div>
      ...
      <div class="mt-3">
        ...
        <input id="direccion" name="direccion" type="text"
               ...
               value="{{ old('direccion', $cliente->direccion) }}" maxlength="60"
