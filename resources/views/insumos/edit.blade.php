...
<div class="container">
  <div class="md-card">
    <h2 class="md-title"><i class="bi bi-pencil-square"></i> {{ $insumo->nombre }}</h2>
    ...
    <form action="{{ route('insumos.update', $insumo->id) }}" method="POST" novalidate>
      ...
      <div class="mb-3">
        ...
        <input id="nombre" name="nombre" type="text"
               ...
               value="{{ old('nombre', $insumo->nombre) }}" required maxlength="50" autofocus>
      </div>
