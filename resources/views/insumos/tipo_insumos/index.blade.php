        ...
        <table style="width:100%; border-collapse:collapse; margin-top:20px;">
            ...
            @forelse($tiposInsumo as $type)
                <tr style="background:#F4EFEE; border-bottom:1px solid #000;">
                    <td style="padding:10px;">{{ $type->id }}</td>
                    <td style="padding:10px;">{{ $type->nombre }}</td>
            ...
            @empty
                <tr>
                    <td colspan="3" style="padding:15px; text-align:center;">
                        No hay tipos de insumos registrados.
                    </td>
                </tr>
            @endforelse
            </tbody>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.form-delete-insumo').forEach(form => {
                ...
                form.addEventListener('submit', function (e) {
                    ...
                    Swal.fire({
                        title: '¿Eliminar este tipo de insumo?',
                        html: `<b>${nombre}</b>`,
                        icon: 'warning',
